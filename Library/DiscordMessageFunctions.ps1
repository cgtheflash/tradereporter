...
Function EOW-Report {
  ...
  BEGIN {
    ...
    If ($TradeObject.AvgDailyProfit -lt 0) {
      $InvertCalc = $TradeObject.AvgDailyProfit * -1
      $TempAvgProfit = '-$' + $InvertCalc.ToString()
    }
    else {
      $TempAvgProfit = '$' + $TradeObject.AvgDailyProfit.ToString()
    }
...
Function EOM-Report {
  ...
  BEGIN {
    ...
    If ($TradeObject.AvgWeeklyProfit -lt 0) {
      $InvertCalc = $TradeObject.AvgWeeklyProfit * -1
      $TempAvgProfit = '-$' + $InvertCalc.ToString()
    }
    else {
      $TempAvgProfit = '$' + $TradeObject.AvgWeeklyProfit.ToString()
    }
